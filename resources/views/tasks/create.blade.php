...
@section('content')
	...
	@can('update', $project)
		...
		<form method="POST" action="/projects/{{ request()->route('project_id') }}/tasks" enctype="multipart/form-data">
			@csrf

			<div>
				Project ID:
				<br>
				<input type="text" name="project_id" value="{{ request()->route('project_id') }}" readonly>
			</div>
